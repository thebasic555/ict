...
public class MainController {
	...
	public static void main(String[] args)
	{
		...
		String _m = "micro/movies.csv";
		String _u = "micro/users.train.csv";
		
		BaseMovieRecommender _b = new SimpleMovieRecommender();
//		Map<Integer, Movie> _c = _b.loadMovies("micro/movies.csv");
//		Map<Integer, User> _d = _b.loadUsers("micro/users.train.csv");
